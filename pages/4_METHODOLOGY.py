...
This will restore your Methodology page to a working state with Mermaid diagrams. Let me know when this is done or if you need further help!import streamlit as st
from streamlit_mermaid import st_mermaid
...
This will restore your Methodology page to a working state with Mermaid diagrams. Let me know when this is done or if you need